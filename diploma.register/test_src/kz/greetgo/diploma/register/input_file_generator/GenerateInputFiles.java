package kz.greetgo.diploma.register.input_file_generator;
...
public class GenerateInputFiles {
  ...
  private static String rndAccountNumber() {
    return RND.strInt(5) + "KZ" + RND.strInt(3) + "-" + RND.strInt(5) + "-" + RND.strInt(5) + "-" + RND.strInt(7);
  }
  ...
  static class Phone {
    ...
    static Phone next() {
      ...
      if (random.nextInt(5) == 0) {
        sb.append(" вн. ").append(RND.strInt(4));
      }
