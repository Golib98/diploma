...
public interface ProjectDao {
  ...
  @Select("insert into projects(professor_id, title, description, isopened, deadline) " +
    "VALUES (#{personId}, #{project.title}, #{project.description}, #{project.isOpened}::boolean, #{project.deadline})" +
    " returning id")
